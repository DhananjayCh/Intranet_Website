	...
	$.fn.FancyFileUpload = function(options) {
		...
		var AddFile = function(uploads, e, data) {
			...
			var StartUpload = function(e) {
				...
				if (settings.startupload)  settings.startupload.call(inforow, UploadDone, e, data);
				else  UploadDone(e, data);
			};
			...
			var RemoveFile = function(e) {
				...
				if (settings.remove)  settings.remove.call(inforow, e, data);
			};
